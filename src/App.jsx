...
function ChapterSection({ page, sectionHeight }) {
  ...
  return (
    ...
    >
      ...
      {/* <div className="chapter-ghost" aria-hidden="true">{page.chapterNumber}</div> */}
      ...
      document.querySelectorAll('.scroll-section').forEach(section => {
        ...
        comics.forEach((comic, i) => {
          ...
          if (isMobile) {
            ...
            // entrance comes from below with base rotation
          ...
          // Base tilt stored as CSS var, used in JS scroll handler too
        ...
        // Once positioned, start observing for entrance animation
